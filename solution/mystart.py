...
import sys
import os 
from utils.myproc import calculate_NJ_tree, calculation_plain, compose_score_matrix, encryption, calculation_enc, decryption
...
enc_mat = encryption(fasta_path=fasta_path, percent=percent_A, name = 'A')
